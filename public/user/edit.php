...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST["update"])) {
    try {
        ...
        if (file_exists($filePath) && is_writable($filePath)) {
            ...
            header("location:" . BASE_URL . "?success=Update Successfully.");
        }
    } catch (Exception $e) {
                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>/?id=<?php echo $id; ?>" method="POST" class="mx-1 mx-md-4">
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            <input type="text" name="username" id="form3Example1c" class="form-control" value="<?php echo $value['username']; ?>" />
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            <input type="email" name="email" id="form3Example3c" class="form-control" value="<?php echo $value['email']; ?>" />
